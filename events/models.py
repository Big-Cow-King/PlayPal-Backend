...
class Event(models.Model):
    ...
    players = models.ManyToManyField('auth.User', null=True,
                                     blank=True)  # TODO: Need to be edit after merging with user app
    ...
    admins = models.ManyToManyField('auth.User', related_name='admin_events',
                                    null=True,
                                    blank=True)  # TODO: Need to be edited after merging with user app
