    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.ImageField(blank=True, null=True, upload_to='static/events/attachments/')),
                ...
                ('admins', models.ManyToManyField(blank=True, null=True, related_name='admin_events', to=settings.AUTH_USER_MODEL)),
                ...
                ('players', models.ManyToManyField(blank=True, null=True, to=settings.AUTH_USER_MODEL)),
